...
module Pretty
  ( AnsiStyle, bold, italicized, underlined, color, colorDull, Color(..)
  , Doc
...
import Data.Text.Prettyprint.Doc.Render.Terminal(AnsiStyle, bold, italicized, underlined, color, colorDull, Color(..))
